...
export type ProgramSettingsSideNavLiveProps = {
  selectedNavId: string;
  onNavSelect: (id: string) => void;
};

export function ProgramSettingsSideNavLive({ selectedNavId, onNavSelect }: ProgramSettingsSideNavLiveProps) {
    ...
    >
      <SidebarHeader>
        <MenuItem
          ...
          onClick={() => router.push("/admin-migrate/programs")}
        />
      </SidebarHeader>
