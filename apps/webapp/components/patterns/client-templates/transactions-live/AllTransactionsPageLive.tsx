...
export type AllTransactionsPageLiveProps = {
  data: TransactionRow[];
};

/** All real transactions grouped by status, revealed 50 at a time on scroll. */
export function AllTransactionsPageLive({ data }: AllTransactionsPageLiveProps) {
