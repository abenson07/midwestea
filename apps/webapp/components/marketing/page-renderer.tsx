import { CustomPlaceholder } from "@/components/marketing/custom-placeholder";
import { EnrollmentBar, type EnrollmentBarProps } from "@/components/marketing/enrollment-bar";
import { enrollmentBarDefaults } from "@/lib/marketing/enrollment-bar-defaults";
import { getCourseEnrollmentBarProps } from "@/lib/marketing/course-enrollment-bar";
import {
  ProgramHero,
  ProgramHeroDefaults,
  type ProgramHeroProps,
} from "@/components/marketing/program-hero";
import { componentRegistry } from "@/lib/marketing/component-registry";
import {
  customComponentRegistry,
  isCustomComponentKey,
} from "@/lib/marketing/custom-component-registry";
