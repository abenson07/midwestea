...
export const Header108 = (props: Header108Props) => {
  ...
  const leftImageGroup = {
    x: useTransform(scrollYProgress, [0, 1], isMobile ? ["0vw", "-25vw"] : ["0vw", "-32vw"]),
  };

  const centerImageContainer = {
    x: useTransform(scrollYProgress, [0, 1], isMobile ? ["0vw", "-25vw"] : ["0vw", "-32vw"]),
    width: useTransform(scrollYProgress, [0, 1], isMobile ? ["50vw", "100vw"] : ["36vw", "100vw"]),
    height: useTransform(scrollYProgress, [0, 1], isMobile ? ["60vh", "100vh"] : ["80vh", "100vh"]),
  };
      ...
      <div className="px-[5%] pt-16 md:pt-24 lg:pt-28">
        <div className="container">
          <div className="mx-auto w-full max-w-lg text-center">
            <h1 className="mea-heading-h1 mb-5 md:mb-6">{title}</h1>
