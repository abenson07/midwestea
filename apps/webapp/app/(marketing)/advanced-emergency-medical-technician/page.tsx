...
export const metadata: Metadata = {
  ...
  description:
    "Advance your EMS career with state-approved AEMT training from MidwestEA. Build on your EMT foundation with expanded scope skills, hands-on labs, and expert instruction in the Kansas City area.",
  openGraph: {
    title: "Advanced Emergency Medical Technician",
    description:
      "Advance your EMS career with state-approved AEMT training from MidwestEA. Build on your EMT foundation with expanded scope skills, hands-on labs, and expert instruction in the Kansas City area.",
