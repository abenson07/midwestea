...
export type Header108BProps = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Header108B = (props: Header108BProps) => {
...
export const Header108BDefaults: Props = {
