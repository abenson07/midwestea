...
function ClassDetailContent() {
    console.log("[ClassDetailContent] Component rendering");
    ...
    useEffect(() => {
        console.log("[ClassDetailContent] useEffect running, classId:", classId);
        if (classId) {
            loadClass();
            loadStudents();
        } else {
            console.log("[ClassDetailContent] No classId provided");
        }
    }, [classId]);
    ...
    const loadStudents = async () => {
        ...
        try {
            ...
            console.log("Students response for class:", { fetchedStudents, fetchError, classId });
            if (fetchError) {
                ...
                console.log("Transformed students for class:", transformedStudents);
                setStudents(transformedStudents);
            } else {
                console.log("No students returned for class");
                setStudents([]);
            }
        } catch (err: any) {
