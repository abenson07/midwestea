...
## Source & target
- **Webflow file**: `midwestea.webflow/purchase-confirmation/bls.html`
- **Target route**: `/purchase-confirmation/bls`
...
- **Headings**:
  - h1: "Order confrimed"
- **Paragraphs**:
  - "We've received your order. We'll be in touch with next steps. If you do not hear from us within 2 business days, please reach out to us at hello@midwestea.com."
- **Links**:
...
- [ ] Create route `app/purchase-confirmation/bls/page.tsx` (or dynamic segment as noted)
