...
## Source & target
- **Webflow file**: `midwestea.webflow/purchase-confirmation/atcc.html`
- **Target route**: `/purchase-confirmation/atcc`
...
- **Detected in this file at lines**: 312, 313, 410

## Section map

| # | Webflow selector | Line | Target component | Component file | Action |
|---|-----------------|------|------------------|----------------|--------|
| 1 | `content-hero` | ~295 | Header 64 | `header-64.tsx` | update-content |

## Section content (verbatim extraction)

### Section 1: `content-hero`
- **Webflow HTML line**: ~295
...
- [ ] Create route `app/purchase-confirmation/atcc/page.tsx` (or dynamic segment as noted)
