...
## Source & target
- **Webflow file**: `midwestea.webflow/purchase-confirmation/bloodborne.html`
- **Target route**: `/purchase-confirmation/bloodborne`
...
- [ ] Create route `app/purchase-confirmation/bloodborne/page.tsx` (or dynamic segment as noted)
