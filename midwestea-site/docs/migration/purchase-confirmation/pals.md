...
## Source & target
- **Webflow file**: `midwestea.webflow/purchase-confirmation/pals.html`
- **Target route**: `/purchase-confirmation/pals`
...
- [ ] Create route `app/purchase-confirmation/pals/page.tsx` (or dynamic segment as noted)
