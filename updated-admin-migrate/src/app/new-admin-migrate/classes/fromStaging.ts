...
import type { StagingClassPrerequisite, StagingPrerequisiteType } from "@/lib/staging/prerequisites";
import type { StagingStudent } from "@/lib/staging/students";
import type { ClassDetail, ClassRosterRow } from "@/components/patterns/client-templates-migrate/classes/classMocks";
import {
  externalLinksFor,
  formatCentsDisplay,
  formatCertLength,
