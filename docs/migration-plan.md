...
| Confirmation + invoice email | 12 (post-launch) |
...
**Email (Plan 12 — post-launch):**

- [ ] Confirmation + invoice email on production
- [ ] (Optional) Transfer Resend login to Kyle via email/password in account settings
